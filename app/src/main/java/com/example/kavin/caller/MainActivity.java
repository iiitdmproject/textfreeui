...
public class MainActivity extends AppCompatActivity {
    ...
    public class MyArrayAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView textView = (TextView) rowView.findViewById(R.id.name_entry);
            ImageView imageView = (ImageView) rowView.findViewById(R.id.NEW);
            textView.setText(values[position]);
            Bitmap bitmap = BitmapFactory.decodeFile(getExternalFilesDir(Environment.DIRECTORY_PICTURES).getPath() + "/MARVEL/" + values[position]);
    ...
    public void onClick(View v){
        ...
        if(id == R.id.newButton){
            ...
            GridView contactListView = (GridView) findViewById(R.id.contactList);
            System.out.println("New Button clicked");
            String[] fromColumns = {"kavin", "9150083650"};
            //int[] toViews = {R.id.display_name, R.id.phone_number};
            String[] contacts = new File(getExternalFilesDir(Environment.DIRECTORY_PICTURES), "MARVEL").list();
//            String[] contacts = getResources().getStringArray(R.array.contacts);
            contactListView.setAdapter(new MyArrayAdapter(this, contacts));
